return function()
    local SelectWeighted1D = require(script.Parent.SelectWeighted1D)
    ...
    describe("Array/SelectWeighted1D", function()
        it("should always select a weighted value", function()
            for _ = 1, 1000000 do
                expect(SelectWeighted1D(WeightTable, "Weight")).to.be.ok()
            end
        end)
        ...
        it("should select the same weighted value with a seed", function()
            ...
            for _ = 1, 1000000 do
                local Temp = SelectWeighted1D(WeightTable, "Weight", 1)
        ...
        it("should produce distributions similar to the weights", function()
            ...
            for _ = 1, 1000000 do
                local Value = SelectWeighted1D(WeightTable, "Weight")
