return function()
    local MutableBinaryInsert1D = require(script.Parent.MutableBinaryInsert1D)

    describe("Array/MutableBinaryInsert1D", function()
        it("should insert into the first index of an empty array", function()
            local Array = {}
            MutableBinaryInsert1D(Array, 1)
        ...
        it("should insert various random numbers, creating an ordered array", function()
            ...
            for _ = 1, 100 do
                MutableBinaryInsert1D(Array, Random:NextInteger(1, 10))
            end
